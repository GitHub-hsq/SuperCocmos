...
.signup-primary-button:focus {
  box-shadow: none !important;
}

/* 隐藏 Continue 文字并用 Next 替换 */
.signup-primary-button span {
...
/* 隐藏箭头图标 */
svg.signup-button-arrow-icon,
.cl-buttonArrowIcon {
  display: none !important;
}

.signup-form-field-label-row {
  margin-bottom: 0;
}
